"""
Name : Mazouz Raphael
Ex 3 : This exercise use neuronal networks to study about specific images to identify them.
"""
...
class neural_network:
    """
    This class is the core of the exercise , here i build the neuronal network according to the user's choice
      1-Cyst
      2-MNIST
      3-CIFAR
    The output will be a cost/loss graph and the accuracy percent
    """
    ...
    def MNIST(self, conf):
        ...
        # Load the targets
        # Note that the targets are stored as digits, that need to be
...
if __name__ == "__main__":
    '''
    this is the main of the neuronal network , according to the choice of the user
    it's active the specifics function
    '''
    print "MENU: 1-Cyst, 2-MNIST, 3-CIFAR"
    set_op = input()
    if set_op <= 0 or set_op > 3:
        print "error of input"
        exit(0)
    print "Configuration: choice according to the sets, so for set 1: [1 ,2 ,3 ]," \
          " for set 2: [4 ,5 ,6] and for set 3: [7 ,8 ,9]"
    conf_op = input()
    if conf_op <= 0 or conf_op > 10:
        print "error of input"
        exit(0)
    ...
    conf_1 = {'hidden_neurons_1': 80, 'hidden_neurons_2': 80, 'batch_size': 30, 'max_nb_of_iterations': 300,
              'learning_rate': 0.1, 'rate': 0.1}
    conf_2 = {'hidden_neurons_1': 50, 'hidden_neurons_2': 50, 'batch_size': 100, 'max_nb_of_iterations': 300,
              'learning_rate': 0.1, 'rate': 0.1}
    conf_3 = {'hidden_neurons_1': 10, 'hidden_neurons_2': 10, 'batch_size': 40, 'max_nb_of_iterations': 4,
              'learning_rate': 0.1, 'rate': 0.1}
    conf_4 = {'hidden_neurons_1': 20, 'hidden_neurons_2': 20, 'batch_size': 25, 'max_nb_of_iterations': 300,
              'learning_rate': 0.1, 'rate': 0.1}
    conf_5 = {'hidden_neurons_1': 20, 'hidden_neurons_2': 20, 'batch_size': 25, 'max_nb_of_iterations': 300,
              'learning_rate': 0.8, 'rate': 0.1}
    conf_6 = {'hidden_neurons_1': 100, 'hidden_neurons_2': 100, 'batch_size': 25, 'max_nb_of_iterations': 300,
              'learning_rate': 0.5, 'rate': 0.5}
    conf_7 = {'hidden_neurons_1': 10, 'hidden_neurons_2': 10, 'batch_size': 25, 'max_nb_of_iterations': 10,
              'learning_rate': 0.1, 'rate': 0.1}
    conf_8 = {'hidden_neurons_1': 30, 'hidden_neurons_2': 30, 'batch_size': 1000, 'max_nb_of_iterations': 10,
              'learning_rate': 0.1, 'rate': 0.1}
    conf_9 = {'hidden_neurons_1': 30, 'hidden_neurons_2': 30, 'batch_size': 10000, 'max_nb_of_iterations': 10,
              'learning_rate': 0.9, 'rate': 0.1}
    ...
    if conf_op == 1:
        ...
        configuration = conf_6
    elif conf_op == 7:
        configuration = conf_7
    elif conf_op == 8:
        configuration = conf_8
    elif conf_op == 9:
        configuration = conf_9

    if set_op == 1:
        neurons.Cyst(configuration)
    elif set_op == 2:
        neurons.MNIST(configuration)
    elif set_op == 3:
        neurons.CIFAR(configuration)
